...
class _SlidingPanelState extends State<SlidingPanel>
  ...
  void didUpdateWidget(SlidingPanel oldWidget) {
    ...
    if (oldWidget.dragMultiplier != widget.dragMultiplier) {
      _metadata!.dragMultiplier = widget.dragMultiplier._safeClamp(1.0, 5.0) as double;
    }
    ...
    return WillPopScope(
      ...
      child: LayoutBuilder(
        builder: (context, BoxConstraints constraints) {
          ...
          _metadata!.constrainedHeight =  _metadata!.constrainedHeight! - (isModal ? 0 : bottomPadding);
